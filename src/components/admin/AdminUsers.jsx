          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-4 mb-4 sm:mb-6">
              ...
              <select
                ...
                className="px-3 sm:px-4 py-2 bg-gray-50 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs sm:text-base"
              >
                      ...
                      <AlertDialog>
                        <AlertDialogTrigger asChild>
                          ...
                          >
                            ...
                            <span>{deletingUserId === user.id ? 'Suppression...' : 'Supprimer'}</span>
                          </motion.button>
                        </AlertDialogTrigger>
                        <AlertDialogContent>
                          <AlertDialogHeader>
