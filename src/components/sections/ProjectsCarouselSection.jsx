      ...
      <div className="p-5 sm:p-6 flex-grow flex flex-col justify-between">
        ...
        {isActive && (
          <Button 
            ...
            className="w-full cyber-button mt-auto text-xs py-3 bg-gradient-to-r from-bizzwiz-electric-cyan/85 to-bizzwiz-magenta-flare/85 hover:from-bizzwiz-magenta-flare hover:to-bizzwiz-electric-cyan group"
          >
            <Eye size={18} className="mr-2.5 transition-transform duration-250 group-hover:scale-110 group-hover:rotate-6" />
            Plonger dans le Projet
            <ArrowRight size={18} className="ml-2.5 opacity-0 transform -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-250"/>
          </Button>
        )}
      </div>
    </motion.div>
