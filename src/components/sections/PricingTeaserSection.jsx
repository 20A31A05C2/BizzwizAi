        ...
        <div className="grid lg:grid-cols-5 gap-x-12 gap-y-14 xl:gap-x-20 items-center">
          ...
          >
            ...
            <motion.div whileHover={{scale: 1.035, y: -3}} whileTap={{scale:0.97}}>
              <Button 
                size="lg" 
                className="cyber-button text-base md:text-lg px-9 md:px-14 py-4.5 md:py-5.5 group" 
                onClick={handleStartProject}
              >
                <Cpu size={26} className="mr-3.5 transition-all duration-300 group-hover:text-yellow-300 group-hover:animate-[spin_1.4s_linear_infinite]" />
                Obtenir Mon Devis Interstellaire
                <ArrowRight size={22} className="ml-3.5 opacity-0 transform -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300"/>
              </Button>
            </motion.div>
          </motion.div>
